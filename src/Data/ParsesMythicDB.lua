	...
	[8] = {
		specs = {
			...
			[63] = {
				...
				[8] = {
					label = "Altar of Fangs",
					talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAMzwYZmZmFMzIzMzMAAAGAwMz0sssMDAwmZmx2YmZGLAAAAAYxMzMDAAMmhxMzMzsMAMzAmxYwMMA",
				},
			},
			[64] = {
				[0] = {
	...
	[12] = {
		specs = {
			...
			[581] = {
				...
				[6] = {
					label = "Den of Nalorakk",
					talentString = "CUkAAAAAAAAAAAAAAAAAAAAAAAAMjxMjhZkZmxYMzMzAGzMzYmZmxAzMjtHYmZbMmBAAAgZbGMMWWYCDzMzsAAAAgBGAAMzAAAAAwA",
				},
				[7] = {
					label = "Murder Row",
